    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('admin/article/cats/'.$articleCat->id) }}" method="POST" enctype="multipart/form-data">
            ...
            @if ($articleCat->image)<img src="{{ URL($articleCat->image) }}" width="100" height="100">@endif
