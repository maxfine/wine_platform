...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Default Content'){{-- 页面标题 --}}</title>
    <meta name="description" content="{{ isset($description) ? $description : '老酒交易平台' }}" />
    <meta name="keywords" content="老酒交易平台,{{ Cache::get('website_keywords') }}" />
